...
const testimonials: TestimonialProps[] = [{
  ...
  content: "Implementing Scrappy in our fulfillment centers reduced workplace injuries by 40% while improving efficiency. The learning capabilities are remarkable.",
  ...
  content: "As a mid-size business, we never thought advanced robotics would be accessible to us. Scrappy changed that equation entirely with its versatility and ease of deployment.",
  author: "Jason Lee",
