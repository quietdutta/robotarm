      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Advanced Intelligence, <br className="hidden sm:block" />Precision Movement
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with cutting-edge reinforcement learning to understand, learn, and adapt to your manufacturing needs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Scrappy learns from your operations, continuously improving its precision and efficiency through advanced RL algorithms."
            index={0}
          />
          <FeatureCard
            ...
            description="Demonstrate tasks once, and Scrappy learns to replicate them with consistent precision and adaptability."
            index={1}
          />
          <FeatureCard
            ...
            description="Advanced servo motors and sensors provide sub-millimeter accuracy for delicate assembly and manufacturing tasks."
            index={2}
          />
          <FeatureCard
            ...
            description="Advanced computer vision and mapping allow Scrappy to navigate complex workspaces and handle varied objects."
            index={3}
          />
          <FeatureCard
            ...
            description="Built-in collision detection and emergency stops ensure safe operation alongside human workers."
            index={4}
          />
          <FeatureCard
            ...
            description="From simple pick-and-place to complex assembly sequences, Scrappy handles a wide range of manufacturing tasks."
            index={5}
          />
        </div>
      </div>
